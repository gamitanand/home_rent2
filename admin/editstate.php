        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="viewstates.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    $tname = $_POST["statename"];
                                    $id = $_GET["updateid"];



                                    $sql = mysqli_query($conn, "SELECT * FROM  table_states where state_name='$tname' ") or die(mysqli_error($conn));

                                    if (mysqli_num_rows($sql) <= 0) 
                                    
                                    
                                    {
                                        $result = mysqli_query($conn, "UPDATE table_states SET state_name='$tname' WHERE state_id='$id'") or die(mysqli_error($conn));
                                ...
                                if (isset($_GET["updateid"])) {
                                    $id = $_GET["updateid"];
                                    $result = mysqli_query($conn, "select * from table_states where state_id='$id'") or die(mysqli_error($conn));
                                ...
                                <form method="post" id="frm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            ...
                                            <input type="text" value="<?php echo $row["state_name"] ?>" name="statename" id="statename" class="form-control" placeholder="state name">
                                        </div>
                                        <div class="	pt-3">
