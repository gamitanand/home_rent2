                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    $sql = mysqli_query($conn,"select * from type_users where name='$tname'")or die(mysqli_error($conn));

                                    if(mysqli_num_rows($sql)<=0)
                                    { 

                                        $result = mysqli_query($conn, "insert into type_users(name,email,mobile,photo,password) values('$tname','$Description','$filename','$filename2')") or die(mysqli_error($conn));
                                ...
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            ...
                                            <input type="textarea" name="username" id="username" class="form-control" placeholder="Enter Username">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Email</label>
                                            <input type="hidd" name="email" id="email" class="form-control" placeholder="Enter Email">

                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Photo</label>
                                            <input type="file" name="Img1" id="Img1" class="form-control" placeholder="Upload Photo">

                                        </div>
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Password</label>
                                            <input type="hidd" name="pass" id="pass" class="form-control" placeholder="Enter Password">
