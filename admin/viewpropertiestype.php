            ...
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View property Type</li>
                    </ol>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">View Property Type</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <!-- <?php echo $row['type_imges']; ?></td> -->
                                                    <td><img src="uploads/propertytype/<?php echo $row['type_imges']; ?>" height="100" width="100" alt=""></td>
                                                    <td>
                                                        <a href="editpropertytype.php?updateid=<?php echo $row["type_id"] ?>" class="btn btn-primary">Edit</a>
                                                        <button id="btndelete" type="button" data-img="<?php echo $row['type_imges']; ?>" data-id="<?php echo $row["type_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
