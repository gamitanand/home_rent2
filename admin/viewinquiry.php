    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        if (isset($_POST["delete-btn"])) {
            ...
            $result = mysqli_query($conn, "delete from tbl_inquiry where inq_id='$did'") or die(mysqli_error($conn));
        }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <!-- <a href="addinquiy.php" class="btn btn-sm btn-primary me-2">View</a> -->
                </div>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 850px">
                                        ...
                                        <tbody>
                                            <?php
                                            $count = 1;
                                            $result = mysqli_query($conn, "select * from tbl_inquiry as i left join type_users as u on i.user_id=u.user_id left join tbl_property as p on i.property_id=p.property_id") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['inq_text']; ?></td>
                                                    <td>
                                                        <a href="#" class="btn btn-primary">Edit</a>
                                                        <button id="btndelete" type="button" data-id="<?php echo $row["inq_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
