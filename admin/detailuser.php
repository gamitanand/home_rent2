...
<?php
                                                    ...
                                                    <td>
                                                        <a href="detailuser.php" class="btn btn-primary">Edit</a>
                                                        <button id="btndelete" type="button" data-id="<?php echo $row["user_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
