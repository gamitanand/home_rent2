...
<body>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        if(isset($_POST["delete-btn"]))
        {
            ...
            $result = mysqli_query($conn,"delete from type_city where city_id='$did'") or die(mysqli_error($conn));
        }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="addcity.php" class="btn btn-sm btn-primary me-2">Add</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 850px">
                                        ...
                                        <tbody>
                                            ...
                                            $count = 1;
                                            $result = mysqli_query($conn, "select * from type_city as c left join table_states as s on c.state_id=s.state_id") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="btndelete" type="button" data-id="<?php echo $row["city_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
