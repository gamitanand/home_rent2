        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="viewgallery.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            if(isset($_POST["btnsubmit"]))
                            {
                                ...
                                move_uploaded_file($_FILES["typeimg"]["tmp_name"],"uploads/gallery/" . $filename);

                                $result = mysqli_query($conn,"insert into tbl_geallery(img_url) values ('$propertyid','$filename')") or die(mysqli_error($conn));
                            ...
                            ?>
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="typeid" id="typeid" class="form-control" placeholder="office,villa,apartment" >
                                        </div>
                                        <div class="mb-3 col-lg-12">
                                            <label class="form-label">Property Id</label>
                                            <input type="text" name="propertyid" id="typename" class="form-control" placeholder="office,villa,apartment" >
                                        </div>
