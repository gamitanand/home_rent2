...
<head>
    <!-- Title -->
    <title>Edit Property Type</title>
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="viewpropertiestype.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    {
                                        $result =mysqli_query(mysql: $conn,query: "update tbl_property_type set type_name='$tname',type_imges='$newimage' where type_id='$id' ") or die(mysqli_error($conn));
...
if (isset($_GET["updateid"])) {
    $id = $_GET["updateid"];
    $result = mysqli_query($conn, "select * from tbl_property_type where type_id='$id'") or die(mysqli_error($conn));
                                ...
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" value="<?php echo $row["type_name"] ?>" name="typename" id="typename" class="form-control" placeholder="office,villa,apartment">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Type Image</label>
                                            <input type="file" name="typeimg" id="typeimg"  class="form-control" ">
                                            <input  type="hidden"name="oldimg" value="<?php echo $row['type_imges']; ?>" id="oldimg">
                                            <img src="uploads/propertytype/<?php echo $row['type_imges']; ?>" height="100" width="100" alt="">
        ...
        $(document).ready(function() {
            ...
            $("#frm").validate({
                ...
                messages: {
                    ...
                    // typeimg: {
                    //     required: "Please Enter Type Image"
                    // }
                }
