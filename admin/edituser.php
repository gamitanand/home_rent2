        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="viewauser.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    if (empty($_FILES["typeimg"]["name"])) {
                                        $newimage = $oldimage;
                                    } else {
                                        unlink("uploads/users/$oldimage");
                                        $ext = pathinfo($_FILES["email"]["name"], PATHINFO_EXTENSION);
                                        $filename = time() . random_int(1111, 9999) . "." . $ext; //78996555.png
                                        move_uploaded_file($_FILES["email"]["tmp_name"], "uploads/users/" . $filename);
                                    ...
                                    $sql = mysqli_query($conn, "select * FROM type_users where name='$tname' AND ") or die(mysqli_error($conn));

                                    if (mysqli_num_rows($sql) <= 0) {

                                        $result = mysqli_query($conn, "UPDATE articles SET name='$tname', email='$email', photo='$newimage' WHERE user_id='$id'") or die(mysqli_error($conn));
                                ...
                                if (isset($_GET["updateid"])) {
                                    $id = $_GET["updateid"];
                                    $result = mysqli_query($conn, "SELECT * FROM type_users WHERE type_users='$id'") or die(mysqli_error($conn));
                                ...
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            ...
                                            <input type="text" value="<?php echo $row["name"] ?>" name="title" id="title" class="form-control" placeholder="Enter Title">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Email</label>
                                            <input type="text" value="<?php echo $row["email"] ?>" name="description" id="description" class="form-control" placeholder="Description">

                                        </div>
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">OTP</label>
                                            <input type="text" value="<?php echo $row["otp"] ?>" name="description" id="description" class="form-control" placeholder="Description">

                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Photo</label>
                                            <input  type="hidden"name="oldimg" value="<?php echo $row['img1']; ?>" id="oldimg">
                                            <input type="file" name="Img1" id="Img1" class="form-control" placeholder="Upload img 1">
                                            <img src="uploads/articles/<?php echo $row['photo']; ?>" height="100" width="100" alt="">
                                        </div>
                                        ...
                                        <div class="	pt-3">
                                            <button type="btnsubmit" name="btnsubmit" class="btn btn-sm btn-primary me-2">save</button>
