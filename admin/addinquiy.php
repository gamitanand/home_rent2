    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        if (isset($_POST["delete-btn"])) {
            ...
            $result = mysqli_query($conn, "delete from articles where articlees_id='$did'") or die(mysqli_error($conn));
        }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="addpropertytype.php">DashBoard</a></li>
                        <li class="breadcrumb-item active">Add Inquiry</li>
                    </ol>
                    <a href="viewinquiry.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    $inqtext = $_POST["inqtext"];



                                    $result = mysqli_query($conn, "insert into tbl_inquiry(user_id,property_id,inq_text) values ( '$userid','$propertyid','$inqtext')") or die(mysqli_error($conn));
                                ...
                                <form method="post">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="text" name="userid" id="userid" class="form-control" placeholder="office,villa,apartment">
                                        </div>

                                        <div class="mb-3 col-lg-12">
                                            <label class="form-label">Property Id</label>
                                            <input type="text" name="propertyid" id="propertyid" class="form-control" placeholder="office,villa,apartment">
                                        </div>

                                        <div class="mb-3 col-lg-12">
                                            <label class="form-label">Inq Text</label>
                                            <input type="text" name="inqtext" id="inqtext" class="form-control" placeholder="office,villa,apartment">
                                        </div>


                                        <div class="	pt-3">
                                            <button type="submit" name="btnsubmit" class="btn btn-sm btn-primary me-2">Submit</button>
