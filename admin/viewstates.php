...
<body>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        if(isset($_POST["delete-btn"]))
        {
            ...
            $result = mysqli_query($conn,"delete from table_states where state_id='$did'") or die(mysqli_error($conn));
        }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="addstates.php" class="btn btn-sm btn-primary me-2">Add</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="btndelete" type="button" data-id="<?php echo $row["state_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
