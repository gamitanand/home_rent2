...
<body>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        if(isset($_POST["delete-btn"]))
        {
            ...
            $result = mysqli_query($conn,"delete from tbl_geallery where gallery_id='$did'") or die(mysqli_error($conn));
        }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <!-- <a href="addtblegallery.php" class="btn btn-sm btn-primary me-2">Add</a> -->
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" c
                                    lass="display" style="min-width: 850px">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Property Id</th>
                                        ...
                                        <tbody>
                                            ...
                                            $count = 1;
                                            $result = mysqli_query($conn, "select * from tbl_geallery") or die(mysqli_error($conn));
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="uploads/gallery/<?php echo $row['img_url']; ?>" height="100" width="100" alt=""></td>
                                                    <td>
                                                        <a href="#" class="btn btn-primary">Edit</a>
                                                        <button id="btndelete" type="button" data-id="<?php echo $row["gallery_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
                                                    </td>
