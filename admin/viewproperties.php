    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        //     unlink("uploads/propertytype/$dimg");

        //     $result = mysqli_query($conn,"delete from tbl_property_type where type_id='$did'") or die(mysqli_error($conn));
        // }
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <!-- <a href="addpropertytype.php" class="btn btn-sm btn-primary me-2">Add</a> -->
                </div>
...
if(isset($_POST["btnisactive"]))
{
    ...
    $result = mysqli_query($conn,"update tbl_property set is_active='$data' where property_id='$id' ");
}
?>
     <table id="example" class="display" style="min-width: 850px">
                                        ...
                                        <tbody>
                                            ...
                                            $count = 1;
                                            $result = mysqli_query($conn, "select * from tbl_property as p left join type_users as u on p.user_id=u.user_id left join tbl_property_type as pt on p.type_id=pt.type_id left join tbl_location_area as a on p.area_id=a.area_id") or die(mysqli_error($conn));
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <!-- <td><?php echo $row['property_file']; ?></td>
                                                    <td><?php echo $row['about_property']; ?></td>
                                                    <td><?php echo $row['buildyear']; ?></td> -->
                                                    <td><?php echo $row['rent_amount']; ?></td>
                                                     <td><img src="uploads/propertytype/<?php echo $row['mainphotos']; ?>" height="100" width="100" alt=""></td>
                                                    <!--<td><?php echo $row['video_url']; ?></td>
                                                    <td><?php echo $row['term&conditions']; ?></td> -->
                                                    ...
                                                    if($row["is_active"]=="Yes")
                                                    {
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="hidden" name="txtdataid" value="<?php echo $row["property_id"] ?>" id="txtdataid">
...
<?php
                                                    ...
                                                    <td><?php echo $row['overlooking']; ?></td>
                                                    <td><?php echo $row['facing']; ?></td> -->

                                                    <td>
                                                        <a href="detailproperty.php?updateid=<?php echo $row["property_id"] ?>" class="btn btn-primary">Edit</a>
                                                        <a href="detailproperty.php?dataid=<?php echo $row["property_id"] ?>" class="btn btn-primary">detial</a>
                                                        <button id="btndelete" type="button" data-img="<?php echo $row['mainphotos']; ?>" data-id="<?php echo $row["property_id"] ?>" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
