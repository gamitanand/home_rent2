        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles d-flex justify-content-between">
                    ...
                    <a href="viewlocation.php" class="btn btn-sm btn-primary me-2">Back</a>
                </div>
                <!-- row -->
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                         ...
                         <?php 
                            ...
                            if(isset($_POST["btnsubmit"]))
                            {
                                ...
                                $tname = $_POST["Areaname"];
                                $cityid = $_POST["cityid"];


                                $sql = mysqli_query($conn,"select * from tbl_location_area where areaname='$tname'")or die(mysqli_error($conn));

                                    if(mysqli_num_rows($sql)<=0)
                                    {
                                        $result = mysqli_query($conn,"insert into tbl_location_area(areaname,city_id  ) values ('$tname','$cityid')") or die(mysqli_error($conn));
                                ...
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    <div class="row">
                                        <div class="mb-3 col-lg-12">
                                            ...
                                            <input type="int" name="areaid" id="areaid" class="form-control" placeholder="Enter Area id" >
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Area name</label>
                                            <input type="text" name="Areaname" id="Areaname" class="form-control" placeholder="Enter Area name">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">City id</label>
                                            <select type="text" name="sid" id="sid" class="form-control" placeholder="Enter State Id">
                                                <option value="">Selecte city Id</option>

                                                <?php

$count = 1;
$result = mysqli_query($conn, "select * from type_city") or die(mysqli_error($conn));
