                            ...
                            <div class="card-body">
                                ...
                                if (isset($_POST["btnsubmit"])) {
                                    ...
                                    if (empty($_FILES["typeimg"]["name"])) {
                                        ...
                                        unlink("uploads/propertytype/$oldimage");
                                    ...
                                    $sql = mysqli_query($conn, "SELECT * FROM articles WHERE title='$tname' AND ") or die(mysqli_error($conn));

                                    if (mysqli_num_rows($sql) <= 0) {

                                        $result = mysqli_query($conn, "UPDATE articles SET title='$tname', description='$description', img1='$newimage', img2='$filename2' WHERE articles_id='$id'") or die(mysqli_error($conn));
                                ...
                                if (isset($_GET["updateid"])) {
                                    $id = $_GET["updateid"];
                                    $result = mysqli_query($conn, "SELECT * FROM articles WHERE articles_id='$id'") or die(mysqli_error($conn));
                                ...
                                <form method="post" enctype="multipart/form-data" id="frm">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            ...
                                            <input type="text" value="<?php echo $row["title"] ?>" name="title" id="title" class="form-control" placeholder="Enter Title">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Description</label>
                                            <input type="text" value="<?php echo $row["description"] ?>" name="description" id="description" class="form-control" placeholder="Description">
                                        ...
                                        <div class="mb-3 col-sm-6col-lg-12">
                                            ...
                                            <img src="uploads/articles/<?php echo $row['img1']; ?>" height="100" width="100" alt="">
                                        </div>

                                        <div class="mb-3 col-sm-6col-lg-12">
                                            <label class="form-label">Image2</label>
                                            <input  type="hidden"name="oldimg2" value="<?php echo $row['img2']; ?>" id="oldimg2">
                                            <input type="file" name="Img2" id="Img2" class="form-control" placeholder="Upload img 2">
                                            <img src="uploads/articles/<?php echo $row['img2']; ?>" height="100" width="100" alt="">
